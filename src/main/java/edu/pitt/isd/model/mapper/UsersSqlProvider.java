...
public class UsersSqlProvider {
    ...
    public String insertSelective(Users record) {
        ...
        if (record.getCurrentConnections() != null) {
            sql.VALUES("CURRENT_CONNECTIONS", "#{currentConnections,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(UsersExample example) {
        ...
        sql.SELECT("CURRENT_CONNECTIONS");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCurrentConnections() != null) {
            sql.SET("CURRENT_CONNECTIONS = #{record.currentConnections,jdbcType=BIGINT}");
        }
        if (record.getTotalConnections() != null) {
