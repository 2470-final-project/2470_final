...
import edu.pitt.isd.model.dto.QuestionExample.Criteria;
import edu.pitt.isd.model.dto.QuestionExample.Criterion;
...
public class QuestionSqlProvider {
    ...
    public String insertSelective(Question record) {
        ...
        if (record.getBlock() != null) {
            sql.VALUES("block", "#{block,jdbcType=INTEGER}");
        }
        ...
        if (record.getQuestion() != null) {
            sql.VALUES("question", "#{question,jdbcType=LONGVARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getBlock() != null) {
            sql.SET("block = #{record.block,jdbcType=INTEGER}");
        }
        ...
        if (record.getQuestion() != null) {
            sql.SET("question = #{record.question,jdbcType=LONGVARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Question record) {
        ...
        if (record.getBlock() != null) {
            sql.SET("block = #{block,jdbcType=INTEGER}");
        }
        ...
        if (record.getQuestion() != null) {
            sql.SET("question = #{question,jdbcType=LONGVARCHAR}");
        }
