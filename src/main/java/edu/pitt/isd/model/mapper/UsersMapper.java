...
public interface UsersMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into users (username, password, ", "enabled, create_time, ", "update_time)",
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, username, password, enabled, create_time, update_time", "from users",
     ...
     * @mbg.generated
     */
    @Update({ "update users", "set username = #{username,jdbcType=VARCHAR},", "password = #{password,jdbcType=VARCHAR},",
    ...
    @Select({ "SELECT u.id, u.username, u.enabled, u.create_time, u.update_time, a.authority AS role",
