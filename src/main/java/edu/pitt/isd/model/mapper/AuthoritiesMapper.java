...
public interface AuthoritiesMapper {
     ...
     * @mbg.generated
     */
    @Delete({ "delete from authorities", "where id = #{id,jdbcType=INTEGER}" })
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, username, authority", "from authorities", "where id = #{id,jdbcType=INTEGER}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
            @Result(column = "username", property = "username", jdbcType = JdbcType.VARCHAR),
            @Result(column = "authority", property = "authority", jdbcType = JdbcType.VARCHAR) })
     ...
     * @mbg.generated
     */
    @UpdateProvider(type = AuthoritiesSqlProvider.class, method = "updateByPrimaryKeySelective")
     ...
     * @mbg.generated
     */
    @Update({ "update authorities", "set username = #{username,jdbcType=VARCHAR},", "authority = #{authority,jdbcType=VARCHAR}",
