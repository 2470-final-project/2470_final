...
public interface EvaluationMapper {
     ...
     * @mbg.generated
     */
    @Delete({ "delete from evaluation", "where id = #{id,jdbcType=INTEGER}" })
     ...
     * @mbg.generated
     */
    @Insert({ "insert into evaluation (user_id, course_id, ", "start_time, duration, ", "url, create_time, ", "update_time)",
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, user_id, course_id, start_time, duration, url, create_time, update_time", "from evaluation",
     ...
     * @mbg.generated
     */
    @Update({ "update evaluation", "set user_id = #{userId,jdbcType=INTEGER},", "course_id = #{courseId,jdbcType=INTEGER},",
            "start_time = #{startTime,jdbcType=TIMESTAMP},", "duration = #{duration,jdbcType=INTEGER},",
            "url = #{url,jdbcType=VARCHAR},", "create_time = #{createTime,jdbcType=TIMESTAMP},",
