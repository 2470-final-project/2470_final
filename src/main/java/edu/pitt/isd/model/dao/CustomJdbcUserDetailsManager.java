...
public class CustomJdbcUserDetailsManager extends JdbcDaoImpl implements UserDetailsManager, GroupManager {
...
//        }
//
//        Users thisUser = usersDao.selectByUsername(returnUsername);
//        final CustomUserDetails userToReturn = new CustomUserDetails((User) userFromUserQuery);
//        userToReturn.setId(thisUser.getId());
//        userToReturn.setFirstname(thisUser.getFirstname());
//        userToReturn.setLastname(thisUser.getLastname());
//        return userToReturn;
//
//    }
    ...
    public void createGroup(final String groupName, final List<GrantedAuthority> authorities) {
        ...
        logger.debug(
                "Creating new group '" + groupName + "' with authorities " + AuthorityUtils.authorityListToSet(authorities));
